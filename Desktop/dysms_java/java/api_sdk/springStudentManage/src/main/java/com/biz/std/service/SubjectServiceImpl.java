...
public class SubjectServiceImpl implements SubjectService {
        ...
        * */
        ...
        if(scorePOS.size() > 0){
            ...
            for(StudentPO studentPO : studentPOS){
                ...
                avgScore = totalScore.divide(new BigDecimal(studentPO.getScorePOS().size()));
                //设置平均分
            ...
            for(GradePO gradePO : gradePOS){
                ...
                //计算平均分
                avgSocore = totalScore.divide(new BigDecimal(gradePO.getStudentNumber()));
    ...
    public boolean SelectSubject(ScorePO scorePO) {
        ...
        * */
        ...
        BigDecimal studentAvgScore = new BigDecimal(studentPO.getAvgScore()).multiply(new BigDecimal(subjectNumberBefore)).divide(new BigDecimal(subjectNumberAfter));
        ...
        BigDecimal subjectAvgScore = new BigDecimal(subjectPO.getAvgScore()).multiply(new BigDecimal(subjectNumberBefore)).divide(new BigDecimal(subjectNumberAfter));
