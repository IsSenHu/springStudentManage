...
public class ScoreServiceImpl implements ScoreService {
    ...
    public void inputScore(ScorePO scorePO) {
        ...
        * */
        ...
        score.setStudentPO(studentRepository.findById(scorePO.getStudentPO().getId()).get());
        score.setScore(scorePO.getScore());
        scoreRepository.save(score);
        StudentPO studentPO = studentRepository.findById(scorePO.getStudentPO().getId()).get();
        ...
        if(scorePOS.size() > 0){
            ...
            avgScore = totalScore.divide(new BigDecimal(studentPO.getSubjectNumber()));
