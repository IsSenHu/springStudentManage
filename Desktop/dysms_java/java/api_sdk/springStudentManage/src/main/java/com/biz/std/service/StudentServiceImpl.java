...
public class StudentServiceImpl implements StudentService {
    ...
    public void saveStudent(StudentVO studentVO) {
        ...
        avgScore = totalScore.divide(new BigDecimal(gradePO1.getStudentNumber()));
    ...
    public void deleteStudentById(Integer id) {
        StudentPO studentPO = studentRepository.findById(id).get();
        //得到该学生所在的班级
        ...
        if(gradePO.getStudentNumber() == 0){
            ...
            avgScore = totalScore.divide(new BigDecimal(gradePO.getStudentNumber()));
        ...
        if(subjectPOS.size() > 0){
            ...
            for(SubjectPO subjectPO : subjectPOS){
                ...
                if(studentNumber2 > 0){
                    ...
                    avgScore = totalScore.divide(new BigDecimal(subjectPO.getStudentNumber()));
    ...
    public void updateStudent(StudentVO studentVO) {
        ...
        BeanUtils.copyProperties(studentVO.getGradeVO(), studentPO.getGradePO());
        //查询出该学生的所有的学科
        Set<SubjectPO> subjectPOS = studentRepository.findById(studentPO.getId()).get().getSubjects();
        ...
        * */
        //获得该先前学生所在的班级
        GradePO gradePOBefore = studentRepository.findById(studentPO.getId()).get().getGradePO();
        //获得现在所在的班级
        ...
        if(!gradePOBefore.getGradeId().equals(gradePOAfter.getGradeId())){
            ...
            * */
            ...
            if(studentPOSBefore.size() > 0){
                ...
                avgScore = totalScore.divide(new BigDecimal(gradePOBefore.getStudentNumber()));
            ...
            if(studentPOSAfter.size() > 0){
                ...
                avgScore1 = totalScore1.divide(new BigDecimal(gradePOAfter.getStudentNumber()));
